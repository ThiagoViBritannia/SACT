      ...
      <div >
        <div align="center">
          <h1 align="center">
            ...
            <hr style={{width:'100%',marginTop:"-0.6%"}} />
          </h1>
        </div>
            ...
            <form onSubmit={this.handleSubmit} >
              ...
              (shareholder, idx) => (
                  <div className="shareholder">
                    ...
                    />
                    <img align="right" src={lix} style={{width:"4.5%", marginTop:"2.8%", marginLeft:"-15%"}} onClick={this.handleRemoveShareholder(idx)}/>
                  </div>
                )
                ...
                <div align="center">
                  <img
                    align = "center"src={mais} style={{width:"7%"}}
                    type="button"
